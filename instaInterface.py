...
class Botinstagram:
    ...
    def __init__(self):
        self.window = Tk()
        self.window.iconbitmap('iconinsta.ico')
    ...
    def start(self):
        ...
        while True:
            for coments in lista_comentarios:
                time.sleep(4)
                textarea = self.navegador.find_element_by_xpath('/html/body/div[1]/div/div[1]/div/div[1]/div/div/div[1]/div[1]/section/main/div[1]/div[1]/article/div/div[2]/div/div[2]/section[3]/div/form/textarea')
                time.sleep(1)
                textarea.click()
                time.sleep(1)
                textarea = self.navegador.find_element_by_xpath('/html/body/div[1]/div/div[1]/div/div[1]/div/div/div[1]/div[1]/section/main/div[1]/div[1]/article/div/div[2]/div/div[2]/section[3]/div/form/textarea')
                ...
                time.sleep(6)
                self.navegador.find_element_by_xpath('/html/body/div[1]/div/div[1]/div/div[1]/div/div/div[1]/div[1]/section/main/div[1]/div[1]/article/div/div[2]/div/div[2]/section[3]/div/form/button/div').click()
            time.sleep(260)
